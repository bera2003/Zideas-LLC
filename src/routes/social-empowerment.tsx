      ...
      <>
        ...
        <section className="mt-6 max-w-4xl mx-auto px-4">
          ...
          <p className="mt-6 text-center text-[#4E84E7] leading-relaxed text-sm md:text-base">
            ...
            <br />
            <br />
            Through our Social Empowerment vertical, we offer personalized
            training in AI, Analytics, and emotional intelligence, empowering
            individuals to embrace new ways of working and confidently navigate
            the digital landscape. We offer the following services:
          </p>
