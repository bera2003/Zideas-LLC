  ...
  component: () => (
    <section className="mt-6 max-w-4xl mx-auto">
      ...
      <p className="mt-6 text-foreground/90 leading-relaxed">
        As AI scales, so does risk. Zideas helps enterprises build governance, model-risk, fraud,
        and operational-resilience programs that keep pace with rapidly evolving regulation and
        adversarial threats — without slowing the business down.
      </p>
    </section>
  ),
});
