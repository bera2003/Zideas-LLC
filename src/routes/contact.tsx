  ...
  component: () => (
    <section className="mt-6 max-w-2xl mx-auto text-center">
      ...
      <p className="mt-6 text-foreground/90">
        Tell us about the venture you want to build.
      </p>
      <a
      ...
      <div className="mt-10 grid sm:grid-cols-3 gap-4 text-sm text-muted-foreground">
        <div><p className="text-accent">USA</p><p>New York</p></div>
        <div><p className="text-accent">Canada</p><p>Toronto</p></div>
        <div><p className="text-accent">India</p><p>Bengaluru</p></div>
      </div>
    </section>
  ),
});
